...
! function(a, b) {
	...
	function c(a, b) {
		...
		a.hasOwnProperty("staticservers") && (a.static_servers = a.staticservers), a.hasOwnProperty("apiserver") && (a.api_server = a.apiserver);
		var d = this;
		return d.id = o(), k.z(d.id), Q.z(d.id, d), k.B("error", sa.onError, d.id), d.config = B(a, d), d.config.protocol = d.config.https ? "https://" : location.protocol + "//", "https://" === d.config.protocol && (d.config.https = !0), b || a.offline ? (P(!1, a, d), a.popupbtnid && d.bindOn("#" + a.popupbtnid)) : G(d.config.api_server + "/get.php?" + m(a), P, d), O(d), d
	}
	...
	g.x = function(a, b, c) {
		...
		return h[a] = {}, h[a].status = "loaded", h[a].content = d, k.y(a + "Loaded"), d
	};
	var k = {};
	k.b = {}, k.b.global = {}, k.z = function(a) {
		k.b[a] = {}
	}, k.A = function(a) {
		k.b[a] = void 0
	}, k.B = function(a, b, c) {
		...
		var d;
		d = c ? k.b[c][a] : k.b.global[a], d.splice(p(b, d), 1)
	}, k.D = function(a, b) {
		q(k.b, b)
	}, k.v = function(a, b) {
		var c, d = k.b[b][a];
		if(d)
			for(var e = 0; e < d.length; e++) c = d[e], c && (c.callback.call(Q.t("self", b)), c.once && (k.C(a, c, b), e -= 1))
	}, k.y = function(a) {
		var b, c = k.b.global[a];
		if(c)
			for(var d = 0; d < c.length; d++) b = c[d], b && (b.callback(), b.once && (k.C(a, b), d -= 1))
	};
	var l = function(a, b) {
			var c = b || {};
		...
		B = function(a, b) {
			return A(z, a), b.config ? l(a, l(b.config)) : l(a, l(y))
		},
		C = function(a, b) {
		...
		F = function(a, b, c) {
			var d = a.config.static_servers,
				...
				j = function(a, b) {
					return b.indexOf("pictures/") === -1 && (b = "/static/" + b), e + h(d[a]) + i(b)
				};
			"function" != typeof c && (c = function() {});
			var l = function(a, b) {
					return a ? (g += 1, void m(b)) : void c(!1, b)
				},
				m = function(d) {
					return g >= f ? (b.indexOf("pictures") === -1 && k.v("error", a.id), void c(!0, d)) : void(b.indexOf(".js") > -1 ? E(j(g, b), l) : b.indexOf(".png") > -1 || b.indexOf(".jpg") > -1 || b.indexOf(".webp") > -1 || b.indexOf(".svg") > -1 ? C(j(g, b), l) : b.indexOf(".css") > -1 ? D(a, j(g, b), l) : (b && w("no such resource: " + b), c(!0, d)))
				};
			m(null)
		},
		G = function(b, c, d) {
			...
			var e = "geetest_" + o();
			a[e] = function(b) {
				b.error && (w(b.error), k.v("error", d.id), k.v("statusChange", d.id), q(a, e)), c.call(d, !1, b, d)
			}, E(b + "&callback=" + e, function(c) {
				c && (w("GeeTest Error: request " + b + " can not access"), k.v("error", d.id), k.v("statusChange", d.id), q(a, e))
			})
		},
		H = document.createElement("img");
	H.onload = H.onerror = function() {
		var a = ".jpg";
		2 === H.height && (a = ".webp"), z.webp = a, k.y("WebPLoaded")
	...
	document && document.body && L(), I && (z.webp = ".jpg");
	var M = function(b, c) {
			var d;
		...
		O = function(a) {
			if(K) {
				...
				b.id = "geetest_style_detect_178273px", Q.G("styleDetectEle", b, a.id), document.getElementsByTagName("body")[0].appendChild(b)
			}
		};
	c.type = "slide";
	var P = function(b, c, d) {
			return !(b || !c) && (d.config.debugConfig && (c = l(d.config.debugConfig, c), d.config = B(c, d)), J == -1 && L(), void f.parallel([function(a) {
				...
				g && g.c(), c.offline ? d.config = B(e.c(d), d) : d.config = B(c, d), k.B("success", sa.onSuccess, d.id), k.B("refresh", sa.onRefresh, d.id), k.B("fail", sa.onFail, d.id), k.B("forbidden", sa.onForbidden, d.id), k.B("abuse", sa.onAbuse, d.id), k.u("DOMReady", function() {
					d.config.benchmark && i("Benchmark").c(d), "popup" === d.config.product && ja.c(d)
				}, d.id), k.u("DOMReady", sa.onReady, d.id), f.serial([function(a) {
					...
					if(z.loaded_theme[d.config.theme]) d.config.mobile && !z.mobileSkins[d.config.theme] ? k.u(d.config.theme + "Loaded", function() {
						Q.G("loaded", !0, d.id), k.v("loaded", d.id)
					}) : (Q.G("loaded", !0, d.id), k.v("loaded", d.id));
					else if(z.loaded_theme[d.config.theme] = !0, d.config.mobile) {
						if(a.GeeTestSkins && a.GeeTestSkins[d.config.theme]) return z.mobileSkins[d.config.theme] = a.GeeTestSkins[d.config.theme], Q.G("loaded", !0, d.id), void k.v("loaded", d.id);
						F(d, d.config.theme + "/skin." + d.config.theme_version + ".js", function(b) {
							return b ? (w("svg " + d.config.theme + " skin.js can not loaded"), void k.v("error", d.id)) : (z.mobileSkins[d.config.theme] = a.GeeTestSkins[d.config.theme], k.y(d.config.theme + "Loaded"), Q.G("loaded", !0, d.id), void k.v("loaded", d.id))
						})
					} else f.parallel([function(a) {
						F(d, d.config.theme + "/style" + (d.config.https ? "_https" : "") + "." + d.config.theme_version + ".css", function(b) {
							b && k.v("error", d.id), a(null, !0)
						})
					}, function(a) {
						setTimeout(function() {
							a(null, !0)
	...
	S.H = function ua(a, b, c) {
		...
		for(d in a)
			if(a.hasOwnProperty(d)) {
				var f, g = d.split("."),
					h = "" === g[0] ? "div" : g[0],
					i = g[1];
				"input" === h ? (f = document.createElement(h), f.className = i, f.type = "hidden", f.name = i) : (f = document.createElement(h), f.className = i), b.appendChild(f), c(f, "." + i.split(" ")[0]), ua(a[d], f, c)
			}
		...
		try {
			if(b.nodeType === d) return b
		} catch(f) {
			throw new Error("接口" + c + "传参错误:" + e.domSelectorError)
		}
	}, S.L = function(a) {
		try {
			for(var b = a; a.parentNode != document.body && b.offsetTop - a.parentNode.offsetTop < 160;) a = a.parentNode, "hidden" == M(a, "overflow") && (a.style.overflow = "visible")
		} catch(c) {}
	}, S.M = function(a) {
		...
		a.style.top = S.N(b) - 160 + "px", a.style.left = S.M(b) + "px"
	}, S.P = function(a, b) {
		var c = this;
		a = S.K(a, "appendTo"), S.Q(c);
		var d = c.$;
		if("gyroscope" === c.config.type) i("Gyro").c(c).S(c).R(c);
			...
			if(S.T(c, !0), S.U(c), S.V(c), S.W(c, !0), ca.X(c), "curtain" === c.config.type) {
				var g = i("Curtain");
				g.X(c)
			}
			d(".gt_flash").style.height = c.config.height - 22 + "px"
		}
		if(c.dom.style["touch-action"] = "none", c.dom.style["ms-touch-action"] = "none", na(c), c.dom.id = "geetest_" + c.id, c.config.mobile ? c.dom.className = "gt_holder gt_mobile_holder gt_" + c.config.product : c.dom.className = "gt_holder gt_" + c.config.product, "float" != c.config.product || c.config.mobile || ia(c), "popup" != c.config.product || c.config.mobile) b ? S.J(a, c.dom) : a.appendChild(c.dom);
		else {
			document.body.appendChild(c.dom);
			var h = d(".gt_input");
			b ? S.J(a, h) : a.appendChild(h)
		}
		if("gyroscope" === c.config.type && Q.G("scale", c.dom.clientWidth / 260, c.id), "float" === c.config.product && !c.config.mobile)
			if(c.config.sandbox) {
				var j = d(".gt_widget");
				c.dom.removeChild(j);
				var l = document.createElement("div");
				l.className = c.dom.className + " gt_clone", l.appendChild(j), document.getElementsByTagName("body")[0].appendChild(l), S.O(l, c.dom), c.cloneDom = l
			} else setTimeout(function() {
				S.L(c.dom)
			}, 2e3);
		Q.G("DOMReady", !0, c.id), k.v("DOMReady", c.id), c.config.mobile && (c.dom.style.height = "0")
	}, S.T = function(a, b) {
		var c = a.$;
		if(T.Y(c(".gt_curtain")), T.Y(c(".gt_curtain_button")), T.Y(c(".gt_curtain_tip")), T.Y(c(".gt_curtain_knob")), "slide" == a.config.type) ca.Z(a, b);
		else {
			var d = i("Curtain");
			ca.Y(a, b), d.Z(a, b)
		}
		...
		var b = a.$,
			c = b(".gt_logo_button");
		a.config.logo ? (c.href = z.homepage, c.target = "_blank") : S._(c, "gt_no_logo"), a.config.clean && S._(b(".gt_widget"), "gt_clean");
		var d = b(".gt_help_button");
		d.href = z.feedback, d.target = "_blank"
	}, S.U = function(a) {
		var b = a.$(".gt_fullbg"),
			c = a.$(".gt_box_tips");
		...
		if(a) {
			"string" == typeof a && (a = $(a));
			for(var c, d = b.split(" "), e = a.className.split(" "), f = 0, g = d.length; f < g; f++) c = p(d[f], e), c != -1 && e.splice(c, 1);
			a.className = e.join(" ")
		}
	}, S.ba = function(a, b) {
		...
		var d = function() {
			var d = new Date,
				...
				i = function() {
					if(!(h < e))
						if(g) a.config.retry += 1, Q.G("status", "auto", a.id), a.refresh();
						else {
							a.config.retry = 0;
			...
			x.n(b, function(b, c) {
				F(a, c.replace(".jpg", z.webp), function(a, c) {
					h += 1, g || (a ? "fullbg" !== b ? g = !0 : f[b] = !1 : !I && c.src && c.src.indexOf(".webp") > -1 && (!c.width || c.width < 10) ? (z.webp = ".jpg", g = !0) : f[b] = c), i()
				})
			})
		};
		...
		var c = a.$,
			d = a.config.height;
		c(".gt_box_holder").style.height = d + "px", I && (c(".gt_cut_fullbg").style.height = d + "px", c(".gt_cut_bg").style.height = d + "px", c(".gt_curtain_bg_wrap").style.height = d + "px", c(".gt_curtain_bg").style.height = d + "px", c(".gt_cut_curtain").style.height = d + "px");
		var e = a.config.type;
		if("slide" == e) S.ca(a, {
			...
			U.da(d.fullbg.src, d.bg.src, a, b), Q.G("imgload", e, a.id);
			var f = c(".gt_slice");
			I ? f.style.filter = 'progid:DXImageTransform.Microsoft.AlphaImageLoader(src="' + d.slice.src + '")' : (f.style.backgroundImage = "url(" + d.slice.src + ")", f.style.width = (d.slice.width || 60) + "px", f.style.height = (d.slice.height || 60) + "px"), f.style.left = a.config.xpos + "px", f.style.top = a.config.ypos + "px", setTimeout(function() {
				Q.G("status", "ready", a.id), qa.Z("ready", a), k.v("statusChange", a.id)
			}, 400)
		});
		else {
			var f = 900;
			b && (f = 0), S.ca(a, {
				...
				Q.G("imgload", e, a.id), g.style.top = a.config.ypos + "px", g.style.left = a.config.xpos + "px", U.da(d.fullbg.src, d.bg.src, a, b), setTimeout(function() {
					Q.G("status", "ready", a.id), qa.Z("ready", a), k.v("statusChange", a.id)
				}, f)
			})
		}
			...
			var a = function() {
				...
				b = function(a) {
					var b = a(".gt_fullbg"),
						...
						f = a(".gt_slice"),
						g = a(".gt_curtain");
					b.style.backgroundImage = "none", d.style.backgroundImage = "none", g.style.backgroundImage = "none", f.style.backgroundImage = "none", T.Y(b), T.Y(d), T.Y(g), T.Y(f), T.Y(c), T.Y(e)
				},
				c = function(a, b) {
					var c = 300,
						d = 600;
					b && (c = d = 0);
					var e = a.$;
					T.Z(e(".gt_fullbg"), c), "slide" == a.config.type ? (T.Z(e(".gt_bg"), 0, c), T.Z(e(".gt_slice"), 0, c)) : (T.Z(e(".gt_curtain"), d), T.Z(e(".gt_curtain_button"), d))
				},
				d = function(b, c, d, e, f) {
					...
					var i, j, k, l = [];
					if(Q.t(b + "Arr", f.id))
						for(l = Q.t(b + "Arr", f.id), i = 0, j = l.length; i < j; i++) l[i].style.backgroundImage = "url(" + c + ")";
					else {
						Q.G(b + "Arr", l, f.id);
						var m, n = a(),
	...
	ba.evts = {
		...
		focus: [_],
		unload: [aa]
	}, ba.b = [], ba.t = function(a, b) {
		for(var c, d = 0, e = ba.b.length; d < e; d++)
			if(c = ba.b[d], c.dom == a && c.event == b) return c;
		return c = {
			dom: a,
			event: b,
			handlerList: [],
		...
		for(var e, f = ba.evts[c], g = ba.t(b, c), h = 0, i = f.length; h < i; h++) g.handlerList.length && (e = g.ia, a.addEventListener ? b.removeEventListener(f[h], e, !1) : a.attachEvent && b.detachEvent("on" + f[h], e)), a.addEventListener ? (g.handlerList.push(d), g.ia = function(a) {
			for(var c = 0, d = g.handlerList.length; c < d; c++) g.handlerList[c](a).call(b)
		}, b.addEventListener(f[h], d, !1)) : a.attachEvent && b.attachEvent("on" + f[h], d)
	}, ba.ka = function(b, c, d) {
		var e = ba.evts[c],
			f = ba.t(b, c);
		f.handlerList = [];
		for(var g = 0, h = e.length; g < h; g++) a.removeEventListener ? b.removeEventListener(e[g], d, !1) : a.detachEvent && b.detachEvent("on" + e[g], d)
	};
	var ca = {};
	ca.Z = function(a) {
		var b = a.$;
		ca.ea(0, a, !0), T.Z(b(".gt_guide_tip"), 500), T.Z(b(".gt_slider_knob"), 500)
	}, ca.Y = function(a) {
		var b = a.$;
		T.Y(b(".gt_bg"), 500), T.Y(b(".gt_slider_knob"), 500), T.Y(b(".gt_guide_tip"), 500), setTimeout(function() {
			ca.ea(0, a, 0)
		}, 500)
	}, ca.ia = function(a, b) {
		var c = this,
			...
			e = d(".gt_slice"),
			f = d(".gt_slider_knob");
		if(b && b.type) return pa.Z("fail", c, 3e3), qa.Z("lock", c), T.Z(d(".gt_fullbg"), 300), void setTimeout(function() {
			ma(b, c)
		}, 500);
		if(a || "error" === b.message) pa.Z("error", c), qa.Z("error", c), Q.G("status", "error", c.id), k.v("error", c.id);
		else if(b.success) {
			var g = d(".gt_flash");
			Q.G("score", b.score, c.id), pa.Z("success", c), qa.Z("success", c), J || T.Z(d(".gt_ie_success")), T.Z(g, 1500), T.Y(g, 0, 1600), T.Z(d(".gt_fullbg"), 1500), ra.la(b.validate, c), k.v("success", c.id), setTimeout(function() {
				Q.G("status", "success", c.id), k.v("statusChange", c.id)
			}, 400)
		} else "fail" == b.message ? (pa.Z("fail", c), qa.Z("fail", c), T.Y(e, 100), T.Z(e, 100, 100), T.Y(e, 100, 200), T.Z(e, 100, 300), T.ea(e, 400, 500, !1, function() {
			ca.ea(0, c, !0)
		}), T.ea(f, 400, 500), k.v("fail", c.id), setTimeout(function() {
			Q.G("status", "ready", c.id), qa.Z("ready", c), k.v("statusChange", c.id), T.Z(d(".gt_guide_tip"), 500)
		}, 1e3)) : "forbidden" == b.message ? (pa.Z("forbidden", c), qa.Z("forbidden", c), k.v("forbidden", c.id), setTimeout(function() {
			Q.G("status", "auto", c.id), c.refresh()
		}, 4e3)) : "abuse" == b.message && (pa.Z("abuse", c), qa.Z("fail", c), k.v("abuse", c.id), setTimeout(function() {
			Q.G("status", "auto", c.id), c.refresh()
		}, 1500))
		...
		return function(c) {
			...
			if("ready" == d && "slide" == a.config.type && 2 != c.button) {
				...
				"pointerdown" !== c.type || Q.t("pointerdown", a.id) || Q.G("pointerdown", !0, a.id), Q.G("startTime", new Date, a.id), Q.G("status", "moving", a.id), k.v("statusChange", a.id), c.preventDefault ? c.preventDefault() : c.returnValue = !1;
				var f = b(".gt_slider_knob");
				S._(b(".gt_slice"), "gt_moving"), S._(f, "gt_moving");
				...
				Q.G("startX", g, a.id), Q.G("startY", h, a.id), oa.c([Math.round(j.left - g), Math.round(j.top - h), 0], a.id), oa.na([0, 0, 0], a.id), T.Y(b(".gt_fullbg"), 300), T.Y(b(".gt_guide_tip"), 500)
			}
		}
	}, ca.oa = function(a) {
		return function(b) {
			...
			if("moving" == c && "slide" == a.config.type && (!Q.t("pointerdown", a.id) || "pointermove" === b.type)) {
				...
				var d = Q.t("startX", a.id),
					...
					h = parseInt(f);
				ca.ea(h, a), oa.na([Math.round(f), Math.round(g), (new Date).getTime() - Q.t("startTime", a.id)], a.id), a.config.benchmark && i("Benchmark").f(a)
			}
		}
	}, ca.pa = function(a) {
		var b = a.$;
		return function(c) {
			...
			if("moving" == d && "slide" == a.config.type && (!Q.t("pointerdown", a.id) || "pointerup" === c.type)) {
				...
				d = Q.G("status", "lock", a.id), qa.Z("lock", a), S.aa(b(".gt_slice"), "gt_moving"), S.aa(b(".gt_slider_knob"), "gt_moving");
				var f = Q.t("startX", a.id),
					...
					k = new Date;
				Q.G("endTime", k, a.id), oa.na([Math.round(h), Math.round(j), k.getTime() - Q.t("startTime", a.id)], a.id);
				var l = parseInt(h),
					n = oa.qa(a.id);
				if(a.config.offline) {
					var o = i("Offline");
		...
		var b = a.$,
			...
			d = ca.oa(a),
			e = ca.pa(a);
		Q.G("moveHandler", d, a.id), Q.G("upHandler", e, a.id), ba.e(c, W, ca.ma(a)), ba.e(document, V, d), ba.e(document, X, e)
	}, ca.ra = function(a, b) {
	...
	var da = function(a) {
		...
		ea = function(a) {
			for(var b = a.config.show_delay, c = a.config.hide_delay, d = Q.t("status", a.id), e = "ready" == d || "success" == d || "error" == d, f = Q.t("in", a.id), g = a.$(".gt_widget"), h = Q.t("hideDelay", a.id) || [], j = 0, k = h.length; j < k; j++) clearTimeout(h[j]);
			h = [];
			var l;
			if(e && !f) {
				...
				if("curtain" == a.config.type) {
					var m = i("Curtain");
					l = m.setFloat(!1, a, c), h = h.concat(l)
				}
				h.push(T.Y(g, 400, c)), Q.G("hideDelay", h, a.id)
			} else {
				if(S.ba(g, "gt_show")) return;
				if(b = e ? b : 0, "curtain" == a.config.type) {
					var m = i("Curtain");
					l = m.setFloat(!0, a, b), h = h.concat(l)
				}
				h.push(T.Z(g, 400, b)), Q.G("hideDelay", h, a.id)
			}
		},
		fa = function(a, b) {
		...
		ha = function(a, b) {
			var c = a.target || a.srcElement,
				d = Q.t("in", b.id),
				e = fa(c, b.dom);
			b.config.sandbox && !e && (e = fa(c, b.cloneDom)), d != e && (b.config.sandbox && S.O(b.cloneDom, b.dom), Q.G("in", e, b.id), k.v("hoverChange", b.id))
		},
		ia = function(a) {
			var b = a.$;
			Q.G("in", !1, a.id), T.Y(b(".gt_widget")), ba.e(document, "move", ga(a)), ba.e(document, "up", ga(a)), k.B("statusChange", da(a), a.id), k.B("hoverChange", da(a), a.id)
		},
		ja = {};
	ja.I = function(a, b) {
		a = a || z.lang;
		...
		var b = a.$;
		T.Z(a.dom, 400), "success" == Q.t("status", a.id) && a.refresh(), T.Y(b(".gt_popup_finish")), T.Z(b(".gt_popup_ready"))
	}, ja.Y = function(a) {
		T.Y(a.dom, 400)
	}, ja.c = function(a) {
		if(a.config.mobile) return a;
		var b = Q.t("enablePopup", a.id);
		void 0 == b && Q.G("enablePopup", !0, a.id), k.B("success", function() {
			var b = a.$;
			T.Z(b(".gt_popup_finish")), T.Y(b(".gt_popup_ready")), setTimeout(function() {
				ja.Y(a);
		...
		if(!Q.t("DOMReady", b.id)) return void k.u("DOMReady", function() {
			ja.ta.call(b, a)
		}, b.id);
		if("popup" === b.config.product) {
			...
			d.innerHTML = c.outerHTML, d = d.childNodes[0], c.style.display = "none", c.id = "origin_" + c.id, S.J(c, d);
			try {
				d.href = "javascript:;"
			} catch(e) {}
			Q.G("popup_copy_btn", d, b.id), ba.e(d, "click", function(a) {
	...
	var ka = function(a) {
		...
		la = function(a) {
			if(a.config.retry > 3) return w("can not loaded imgs"), void k.v("error", a.id);
			var b = Q.t("status", a.id);
			if("ready" === b || "success" === b || "auto" === b) {
				if(k.v("statusChange", a.id), Q.G("status", "lock", a.id), ra.fa(a), a.config.mobile) {
					var c = i("SVG");
					c.S(a, !0)
					...
					var e = a.$;
					U.fa(a.$), T.Y(e(".gt_ie_success")), qa.Z("lock", a)
				}
				if(a.config.offline) {
					var f = i("Offline");
				...
				G(a.config.api_server + "/refresh.php?" + m({
					...
					return b ? (w("refresh error"), void k.v("error", a.id)) : void ma(c, a)
				}, a)
			}
		},
		ma = function(a, b) {
			...
			clearTimeout(Q.t("autoRefresh", b.id)), Q.G("autoRefresh", setTimeout(function() {
				b.refresh()
			}, 54e4), b.id)
		};
	...
	var na = function(a) {
			...
			} else ba.e(a.$(".gt_refresh_button"), "click", ka(a));
			Q.G("autoRefresh", setTimeout(function() {
				a.refresh()
			}, 54e4), a.id), k.B("success", function() {
		...
		oa = function() {
			var a = function(a, b) {
				...
				f = function(a) {
					for(var b, f = c(Q.t("arr", a)), g = [], h = [], i = [], j = 0, k = f.length; j < k; j++) b = e(f[j]), b ? h.push(b) : (g.push(d(f[j][0])), h.push(d(f[j][1]))), i.push(d(f[j][2]));
	...
	pa.da = function(a, b, c, d) {
		...
		g.className = "gt_info_type", r(g, e[0]);
		var h = document.createElement("span");
		h.className = "gt_info_content", r(h, e[1]), r(a, ""), a.appendChild(g), a.appendChild(h)
	}, pa.Z = function(a, b, c) {
		var d = b.$;
		...
		var h, i = 3,
			j = function() {
				pa.da(k, a, b.config.lang, {
					count: i
				}), i--, i == -1 && clearInterval(h)
			},
			k = d(".gt_info_text"),
			l = {};
		if("success" == a) {
			var m = (Q.t("endTime", b.id).getTime() - Q.t("startTime", b.id)) / 1e3;
			l.sec = m.toFixed(1), l.score = 100 - Q.t("score", b.id)
		} else "forbidden" == a && (j(), h = setInterval(j, 1e3), c = 4e3);
		"forbidden" != a && pa.da(k, a, b.config.lang, l), T.Z(e, 200), c && Q.G("infoHide", T.Y(e, 300, c), b.id)
	};
	var qa = {};
	qa.Z = function(a, b) {
		var c = b.$;
	...
	ra.ua = function(a, b) {
		...
		Q.G("geetest_challenge", d, b.id), Q.G("geetest_validate", e, b.id), Q.G("geetest_seccode", f, b.id), c(".geetest_challenge").value = d, c(".geetest_validate").value = e, c(".geetest_seccode").value = f
	}, ra.la = function(a, b) {
		ra.ua(a, b)
	}, ra.fa = function(a) {
		ra.ua(!1, a)
	...
	sa.onStatusChange = function(b, c) {
		...
		"function" == typeof b && b.call(a), sa.onStatusChange("Success", a)
	}, sa.onRefresh = function() {
		var b = this,
			c = Q.t("onRefresh", b.id);
		"function" == typeof c && c.call(b), "function" == typeof a.gt_custom_refresh && a.gt_custom_refresh(b.$)
	}, sa.onFail = function() {
		var a = Q.t("onFail", this.id);
		"function" == typeof a && a.call(this), sa.onStatusChange("Fail", this)
		...
		var c = this,
			d = Q.t("onError", c.id);
		"function" == typeof d && d.call(c), "function" == typeof a.gt_custom_error && a.gt_custom_error(c, c.$), b || (c.config.mobile ? k.v("SvgError", c.id) : (Q.G("status", "error", c.id), qa.Z("error", c), pa.Z("error", c, !1)), clearTimeout(Q.t("autoRefresh", c.id)))
	}, sa.onReady = function() {
		var b = Q.t("onReady", this.id);
		"function" == typeof b && b.call(this), "function" == typeof a.onGeetestLoaded && a.onGeetestLoaded(this)
	}, c.prototype.onSuccess = function(a) {
		if("function" == typeof a) return Q.G("onSuccess", a, this.id), this;
		throw new Error(e.callbackError)
	}, c.prototype.onFail = function(a) {
		if("function" == typeof a) return Q.G("onFail", a, this.id), this;
		throw new Error(e.callbackError)
	}, c.prototype.onRefresh = function(a) {
		if("function" == typeof a) return Q.G("onRefresh", a, this.id), this;
		throw new Error(e.callbackError)
	}, c.prototype.onError = function(a) {
		if("function" == typeof a) return Q.G("onError", a, this.id), this;
		throw new Error(e.callbackError)
	}, c.prototype.onStatusChange = function(a) {
		if("function" == typeof a) return Q.G("onStatusChange", a, this.id), this;
		throw new Error(e.callbackError)
	}, c.prototype.onReady = function(a) {
		if("function" == typeof a) return Q.G("onReady", a, this.id), this;
		throw new Error(e.callbackError)
	}, c.prototype.getPasstime = function() {
		return Q.t("endTime", this.id) - Q.t("startTime", this.id)
	}, c.prototype.hideRefresh = function() {
		var a = this;
		if(!Q.t("DOMReady", a.id)) return k.u("DOMReady", function() {
			a.hideRefresh()
		}, a.id), this;
		if(a.config.mobile) {
			var b = Q.t("eles", a.id);
	...
	var ta = function(a, b, c) {
		var d = (Q.t("eles", a.id), ((Q.t("panelHeight", a.id) || 90) + a.config.height) / 260);
		a.dom.style.width = b + c, a.dom.style.paddingBottom = d * b + c
	};
	return c.prototype.zoom = function(a) {
		var b = this;
		if(!Q.t("DOMReady", b.id)) return k.u("DOMReady", function() {
			b.zoom(a)
		}, b.id), this;
		...
		if(a.dom && a.dom.parentNode && a.dom.parentNode.removeChild(a.dom), "popup" === a.config.product) {
			...
			c && c.parentNode && c.parentNode.removeChild(c), b && (b.style.display = "inline-block", b.id = b.id.replace("origin_", ""));
			var d = a.$(".gt_input");
			d && d.parentNode && d.parentNode.removeChild(d)
		}
		ba.ka(document, "move", Q.t("moveHandler", a.id)), ba.ka(document, "up", Q.t("upHandler", a.id)), Q.A(a.id), k.A(a.id)
		...
		return x
	}), b ? c : (d.type = "shell", a.Geetest ? (a.Geetest.type = a.Geetest.type || void 0, a.Geetest.type !== d.type ? ("slide" === c.type ? d.slide = c : (d.slide = a.Geetest, d[c.type] = c), a.Geetest = d) : a.Geetest[c.type] || (a.Geetest[c.type] = c)) : (d[c.type] = c, a.Geetest = d), void(a.Geetest.define || (a.Geetest.define = function(a, b, c) {
		g.x(a, b, c)
	})))
});