...
Array.prototype.contains = function(needle) {
 ...
 var userList = new Array("00004378", "portaladmin","00002141");
// var userID = '00004378';
 if(userList.contains(window.userID)) {
	var startTime = Date.parse('2017/07/24 08:30:00');//个人足迹开启时间
	var endTime = Date.parse('2017/08/16 23:59:59');//个人足迹结束时间
	var now = new Date();
